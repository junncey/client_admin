<template>
	<el-main class="bg">
		<el-form ref="form" :model="form" status-icon label-width="120px">
			...
			<el-col :xs="24" :sm="12" :lg="8" v-if="user_group == '管理员' || ($check_field('set','user_id') && query.order_id) || $check_field('add','user_id')">
			...
			<!--<el-col :xs="24" :sm="12" :lg="8" v-if="user_group == '管理员' || ($check_field('set','merchant_id') && query.order_id) || $check_field('add','merchant_id')">-->
