		...
		methods: {
            ...
            submit_after(){
                ...
                if (this.form[this.field]){
                    ...
                    this.$get("~/api/commodity_management/get_obj?",query_form,(res)=>{
            ...
            submit_goods(source_id,add_flag){
				let customize_field = []
				customize_field.push({"field_name":"备注","field_value":this.form.remarks});
                this.goods_form = {
                    goods_id: 0,
                ...
                if (add_flag==='set'){
                    ...
                    // 提交事件
                    this.$post("~/api/goods/set?source_table=commodity_management&source_field=" + this.field + "&source_id=" + source_id,this.goods_form,(res)=>{
